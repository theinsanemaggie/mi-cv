...
export default function Footer() {
  return (
    <footer
      className="relative z-10 pt-4 pb-8 mt-10"
    ...
    >
      <div className="flex flex-wrap gap-3 justify-center">
        {SOCIALS.map((s) => (
          <a
            ...
            style={{ color: "var(--pink)", border: "1px solid rgba(227,0,106,0.35)", background: "#0d0010" }}
          >
            {s.icon}
            {s.handle}
          </a>
      ...
      <p className="text-center text-xs mt-5" style={{ color: "var(--muted)" }}>
        © {new Date().getFullYear()} Magalí Amato · código de día, tinta de noche
      </p>
    </footer>
  )
}
